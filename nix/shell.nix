...
pkgs.mkShell {
  ...
  shellHook = ''
    ...
    # Bash through its setup hook (auto-sourced by mkShell). Keeping that logic
    # out of this shellHook ensures this repository exercises the same package
    # contract as consumers.
