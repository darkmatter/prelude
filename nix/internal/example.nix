...
#
# `inputs` is flake-parts' module argument; `inputs.prelude.lib` provides
# mdSplit for the docs pages below.
{inputs, ...}: {
  prelude = {
    ...
    motd = {
      ...
      background = true; # card fill: false/true, a color, or a relative/blend value
    ...
    # Themed starship config (`packages.prelude-prompt` = starship.toml).
    prompt = {
      enable = true;
    ...
    # docs.pages = [
    #   (inputs.prelude.lib.mdSplit ./README.md)  # README, one page per `##` section
